namespace CCE.Audio.Abstract
{
    public interface IAudioManager
    {
        ...
        /// </summary>
        /// <param name="volume">
        ///     A value from 0 to 1 representing the volume of the audio, relative to the absolute volume of the
        ///     loaded audio.
        /// </param>
        ...
        /// </summary>
        /// <param name="volume">
        ///     A value from 0 to 1 representing the volume of the hitsounds, relative to the absolute volume of
        ///     the loaded hitsounds.
        /// </param>
