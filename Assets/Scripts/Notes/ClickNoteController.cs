    ...
    public class ClickNoteController : NoteController
    {
        ...
        public override void Initialize(Note note)
        {
            ...
            gameObject.transform.localScale =
                new Vector3(GlobalState.Config.DefaultNoteSize * (float)note.ActualSize * (note.Type == 0 ? 1 : 0.8f),
                    GlobalState.Config.DefaultNoteSize * (float)note.ActualSize * (note.Type == 0 ? 1 : 0.8f));
        ...
        protected override void UpdateVisuals()
        {
            ...
            NoteBorder.transform.localScale =
                new Vector3(0.6f + ApproachPercentage * 0.4f, 0.6f + ApproachPercentage * 0.4f);
