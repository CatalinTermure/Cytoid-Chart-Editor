...
namespace CCE.Notes
{
    public class LongHoldNoteController : NoteController
    {
        ...
        ///     The parts of the hold note object.
        /// </summary>
        public GameObject TopHollowNoteBody,
            TopFillNoteBodyMask,
            TopFillNoteBody,
            BottomHollowNoteBody,
            BottomFillNoteBodyMask,
            BottomFillNoteBody,
            UpArrow,
            DownArrow,
            FinishIndicator;
        ...
        protected override void UpdateVisuals()
        {
            ...
            if (ApproachPercentage < 1)
            {
                ...
                NoteFill.transform.localScale = NoteBorder.transform.localScale =
                    new Vector3(0.6f + 0.4f * ApproachPercentage, 0.6f + 0.4f * ApproachPercentage);
                InnerNoteBorder.transform.localScale = new Vector3(0.4f + 0.35f * ApproachPercentage,
                    0.4f + 0.35f * ApproachPercentage);
            }
            else
            {
